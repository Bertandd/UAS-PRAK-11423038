...
@section('title', 'Tambah Lokasi Lapangan')
@section('content')
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-info"><i class="fas fa-fw fa-plus"></i> Tambah Data Kategori Lapangan</h6>
    </div>

	<form action="{{ route('admin.field-locations.store') }}" method="post">
        @csrf
		<div class="card-body">
			<div class="row">
